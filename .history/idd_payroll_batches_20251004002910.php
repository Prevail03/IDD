...
if($action == 2){
    ...
    $stmt = sqlsrv_query( $dbconx_global, $sql ,$params );   
    if( $stmt === false) {
        die( print_r( sqlsrv_errors(), true) );
    }
    ...
    $sql = "INSERT INTO [MYDB].[dbo].[contributions_flat_batches_tb] ( flat_scheme_code ,flat_batch_id ,flat_document ,flat_document_type ,flat_posting_date ,flat_initiated_by ,flat_initiated_on ,flat_approved_by ,flat_approved_on ,flat_approved ,flat_action_name ,flat_action_comments ) 
    VALUES ( ?,?,?,?,?,?,?,?,?,?,?,?)";
