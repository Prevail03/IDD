    ...
    <div class="container-fluid  px-5 py-3">
        ...
        <div class="col-sm-12">
                <div class="btn-group" role="group" aria-label="Payroll Actions">
                    ...
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#addMedicalModal">Medical</button>
                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#applyAdvanceModal">Apply for Advance</button>
