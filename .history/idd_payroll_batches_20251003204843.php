					...
					<td>
						<div class="dropdown">
						  ...
						  <div class="dropdown-menu">
						    <a class="dropdown-item" href="./view_payroll_batch_entries.php?batch_id=<?php echo($row['batch_id']); ?>">Payees</a>
						    <a class="dropdown-item" href="./pen_payrolls_processed.php?action=2&batch_id=<?php echo($row['batch_id']); ?>">Approve </a>
						    <a class="dropdown-item" href="./pen_payrolls_processed.php?action=3&batch_id=<?php echo($row['batch_id']); ?>">Reject</a>
						  </div>
						</div>
					</td>
				</tr>
