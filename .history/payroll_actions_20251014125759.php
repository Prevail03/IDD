...
<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['form_name']) && $_POST['form_name'] === "update_payroll") {
            ...
            $bank_code = !empty($_POST['bank_code']); 
        ...
        <div class="col-sm-12">
            ...
            <div class="tab-content" id="payrollTabsContent">
                            ...
                            <?php $i=1; while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) { ?>
                                <tr>
                                    <form action="idd_payroll_actions.php" method="POST">
                                        ...
                                        <td><input type="text" name="bank_code" class="form-control form-control-sm" value="<?= htmlspecialchars($row['bank_code']); ?>"></td>
                ...
                <div class="tab-pane fade p-3" id="medical" role="tabpanel">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addMedicalModal">+ Add Medical</button></br></br>
                    <?php
                ...
                <div class="tab-pane fade p-3" id="exceptions" role="tabpanel">
                    <h5>Exceptions</h5>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addExceptionModal">+ Add Exception</button></br></br>
                    <?php
                    $sql = "SELECT su.user_username, idd.member_name, idd.member_number, exc.* 
                            ...
                            WHERE exc.scheme_code = '$scheme_code' and exc.hidden_status = 'No'
                            ORDER BY idd.member_name ASC";
                    $stmt = sqlsrv_query($conn, $sql);
