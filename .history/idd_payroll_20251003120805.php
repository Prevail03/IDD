        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            if (isset($_POST['form_name']) && $_POST['form_name'] === "load_payroll") {
                ...
                while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                    ...
                    $withdrawals     = (float)$row['annual_withdrawal'];
                    $allowed_annual  = (float)$row['closing_balance'] * 0.15;
                    ...
                    // 2. Overpayment Check
                    // ======================
                    // withdrawals already includes historical totals, 
                    // net is now scaled for this payment period
