            ...
            <form action="load_payroll.php" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        ...
                        <select class="form-control" >
                            <?php
                            $sql = "SELECT * FROM scheme_sub_periods_tb WHERE scheme_period_id =19 ORDER BY sub_period_end_date DESC";
                            $stmt = sqlsrv_query( $conn, $sql ,$params, array('Scrollable' => 'buffered', 'ReturnDatesAsStrings' => true));
                            if( $stmt === false) {
                            ...
                            while($row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)) {
                                echo '<option value="'.$row['sub_period_id'].'">'.$row['sub_period_name'].'</option>';
                            }
