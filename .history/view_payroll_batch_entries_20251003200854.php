...
<?php 
    ...
    if(isset($_GET['delete_payroll'])){
        ...
        $deleted_at = date('Y-m-d H:i:s');
         $sql = "UPDATE MYDB.DBO.idd_payroll_staging SET hidden_status = 'Yes', deleted_at = ?, deleted_by = ? WHERE insert_id = ?"; 
            ...
            <div class="tab-content" id="payrollTabsContent">
                ...
                <div class="tab-pane fade show active p-3" id="payroll" role="tabpanel">
                   ...
                   $sql = "SELECT 
                        ...
                        WHERE stg.scheme_code = ? and hidden_status = 'No'
                        AND stg.batch_id = ?
                            ...
                            <?php $i=1; while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) { ?>
                                <tr>
                                    <form action="idd_payroll_actions.php" method="POST">
                                        ...
                                        <td><input type="number" step="0.01" name="gross_after_deductions" class="form-control form-control-sm" value="<?= htmlspecialchars($row['net_salary']); ?>"></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="view_payroll_batch_entries.php?delete_payroll=<?= $row['staging_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this record?')">Delete</a>
                                        </td>
                                    </form>
                                </tr>
                            <?php } ?>
