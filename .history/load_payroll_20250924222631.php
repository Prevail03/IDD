...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['form_name']) && $_POST['form_name'] === "load_payroll") {
        ...
        $added_by      = $_SESSION['user_id'];  // use this consistently
	...
	<div class="row"  x-data="initiatePayrollForm()" >
	   ...
	   <div class="col-sm-12">
            <div class="btn-group" role="group" aria-label="Payroll Actions">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exceptionsModal">Exceptions</button>
            </div>
        </div>
