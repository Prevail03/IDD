...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['form_name']) && $_POST['form_name'] === "load_payroll") {
        ...
        $sql = "INSERT INTO MYDB.DBO.idd_advance 
                (payroll_id, scheme_code ,start_period, start_sub_period, end_period, end_sub_period, added_by) 
                VALUES (?, ?, ?, ?, ?, ?)";
        $params = [$payroll_id, $start_period, $start_sub_period, $end_period, $end_sub_period, $added_by];
        $stmt = sqlsrv_query($conn, $sql, $params);
	...
	<div class="row"  x-data="initiatePayrollForm()" >
	    ...
	    <div class="col-sm-3">
            <div class = "button-group">
                ...
                <button type="button" class="w-100 btn btn-primary" data-toggle="modal" data-target="#applyAdvanceModal">Apply for Advance</button>
