...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['form_name']) && $_POST['form_name'] === "updateuser") {
        ...
        $sql = "UPDATE MYDB.DBO.idd_payroll 
                SET account_number = ?, bank_code = ?, gross_after_deductions = ? 
                WHERE insert_id = ?";
        $params = [$account_number, $bank_code, $gross_after_deductions, $user_id];
