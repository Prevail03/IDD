        ...
        <div class="col-sm-12">
            ...
            <div class="tab-content" id="payrollTabsContent">
                ...
                <div class="tab-pane fade show active p-3" id="payroll" role="tabpanel">
                    ...
                    $scheme_code = $_SESSION['scheme_code'];
                    $sql = "SELECT stg.staging_id, stg.member_number, stg.member_name, idd.account_number, idd.bank_code,from MYDB.DBO.idd_payroll_staging stg, MYDB.DBO.idd_payroll idd  WHERE stg.scheme_code = '$scheme_code' AND stg.batch_id = '$batch_id' ORDER BY stg.member_name ASC";
