	...
	<div class="row"  x-data="initiatePayrollForm()" >
	    ...
	    <div class="col-sm-3">
            <div class = "button-group">
	            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addPayrollModal">+ Add Payroll Record</button>
                <button type="button" class="w-100 btn btn-primary">Medical</button>
