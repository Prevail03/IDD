                            ...
                            <?php $i=1; while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) { ?>
                                <tr>
                                    <form action="idd_payroll_actions.php" method="POST">
                                        ...
                                        <td><input type="number" step="0.01" name="gross_after_deductions" class="form-control form-control-sm" value="<?= htmlspecialchars($row['gross_salary']); ?>"></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="idd_payroll_actions.php?delete_payroll=<?= $row['staging_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this record?')">Delete</a>
                                        </td>
                                    </form>
                                </tr>
                            <?php } ?>
